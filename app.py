#Telecommunication Support Chatbot
import gradio as gr
from langchain_core.messages import HumanMessage
from telecomm import graph
...
class ChatInterface:
    ...
    def create_interface(self):
        ...
        with chat_interface:
            gr.Markdown("# Telecommunication Support Chatbot")
            gr.Markdown("Welcome to our Telecom Support! How can I help you today?")
